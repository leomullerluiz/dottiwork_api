...
('complete_profile', 'Perfil completo', 'Concluiu o onboarding inicial.', 'onboarding', 'bronze', '/uploads/media/badges/complete_profile.png', 'Insignia de perfil completo', 'user-check', 1, 0, 10, 'profile_onboarding_completed', JSON_OBJECT('target', 1), NOW(), NOW()),
('stack_configured', 'Stack configurada', 'Adicionou pelo menos 3 tecnologias ao perfil.', 'onboarding', 'bronze', '/uploads/media/badges/stack_configured.png', 'Insignia de stack configurada', 'code', 1, 0, 20, 'technology_count', JSON_OBJECT('threshold', 3), NOW(), NOW()),
('preferences_defined', 'Preferencias definidas', 'Salvou preferencias de matching.', 'onboarding', 'bronze', '/uploads/media/badges/preferences_defined.png', 'Insignia de preferencias definidas', 'sliders-horizontal', 1, 0, 30, 'preferences_defined', JSON_OBJECT('target', 1), NOW(), NOW()),
('explorer', 'Explorador', 'Visualizou 5 projetos open source.', 'discovery', 'silver', '/uploads/media/badges/explorer.png', 'Insignia de explorador open source', 'compass', 1, 0, 40, 'activity_event_count', JSON_OBJECT('event_type', 'viewed_project', 'threshold', 5, 'distinct_repositories', true), NOW(), NOW()),
('curator', 'Curador', 'Salvou 3 projetos para acompanhar.', 'discovery', 'silver', '/uploads/media/badges/curator.png', 'Insignia de curador de projetos', 'bookmark', 1, 0, 50, 'repository_state_count', JSON_OBJECT('states', JSON_ARRAY('saved'), 'threshold', 3), NOW(), NOW()),
('technical_focus', 'Foco tecnico', 'Salvou projetos de pelo menos 3 linguagens diferentes.', 'discovery', 'silver', '/uploads/media/badges/technical_focus.png', 'Insignia de foco tecnico', 'layers', 1, 0, 60, 'repository_language_saved_count', JSON_OBJECT('threshold', 3), NOW(), NOW()),
('first_action', 'Primeira acao', 'Abriu um repositorio no GitHub pela primeira vez.', 'contribution', 'bronze', '/uploads/media/badges/first_action.png', 'Insignia de primeira acao no GitHub', 'external-link', 1, 0, 70, 'activity_event_exists', JSON_OBJECT('event_type', 'opened_github', 'target', 1), NOW(), NOW()),
('started_contributing', 'Comecou a contribuir', 'Marcou um projeto como em contribuicao.', 'contribution', 'silver', '/uploads/media/badges/started_contributing.png', 'Insignia de inicio de contribuicao', 'rocket', 1, 0, 80, 'activity_event_or_repository_state_exists', JSON_OBJECT('event_type', 'started_contributing', 'states', JSON_ARRAY('researching', 'working'), 'target', 1), NOW(), NOW()),
('first_pr', 'Primeiro PR', 'Marcou o primeiro pull request como enviado.', 'contribution', 'gold', '/uploads/media/badges/first_pr.png', 'Insignia de primeiro pull request', 'git-pull-request', 1, 0, 90, 'activity_event_or_repository_state_exists', JSON_OBJECT('event_type', 'sent_pull_request', 'states', JSON_ARRAY('pull_request_sent'), 'target', 1), NOW(), NOW()),
('first_contribution', 'Primeira contribuicao', 'Marcou sua primeira contribuicao como concluida.', 'contribution', 'gold', '/uploads/media/badges/first_contribution.png', 'Insignia de primeira contribuicao open source', 'award', 1, 0, 100, 'activity_event_or_repository_state_exists', JSON_OBJECT('event_type', 'marked_contributed', 'states', JSON_ARRAY('contributed'), 'target', 1), NOW(), NOW()),
('beginner_friend', 'Amigo dos iniciantes', 'Interagiu com 3 projetos com good first issues.', 'quality', 'silver', '/uploads/media/badges/beginner_friend.png', 'Insignia de amigo dos iniciantes', 'heart-handshake', 1, 0, 110, 'issue_label_interaction_count', JSON_OBJECT('label', 'good first issue', 'threshold', 3), NOW(), NOW()),
('help_wanted_helper', 'Ajuda bem-vinda', 'Interagiu com 3 projetos com issues help wanted.', 'quality', 'silver', '/uploads/media/badges/help_wanted_helper.png', 'Insignia de ajuda bem-vinda', 'hand-heart', 1, 0, 120, 'issue_label_interaction_count', JSON_OBJECT('label', 'help wanted', 'threshold', 3), NOW(), NOW()),
('exploration_streak', 'Sequencia de exploracao', 'Interagiu com projetos em 3 dias diferentes.', 'consistency', 'silver', '/uploads/media/badges/exploration_streak.png', 'Insignia de sequencia de exploracao', 'calendar-days', 1, 0, 130, 'activity_distinct_days', JSON_OBJECT('threshold', 3), NOW(), NOW()),
('open_source_week', 'Semana open source', 'Teve atividade em 5 dias dentro de 7 dias.', 'consistency', 'gold', '/uploads/media/badges/open_source_week.png', 'Insignia de semana open source', 'calendar-check', 1, 0, 140, 'activity_distinct_days', JSON_OBJECT('threshold', 5, 'within_days', 7), NOW(), NOW()),
('invite_friend', 'Convide um amigo', 'Convidou uma pessoa que criou conta no dotti.work.', 'special', 'silver', '/uploads/media/badges/invite_friend.png', 'Insignia de convite de amigo', 'user-plus', 1, 0, 150, 'referral_count', JSON_OBJECT('threshold', 1), NOW(), NOW()),
('invite_5_friends', 'Conector open source', 'Convidou 5 pessoas que criaram conta no dotti.work.', 'special', 'gold', '/uploads/media/badges/invite_5_friends.png', 'Insignia de conector open source', 'users', 1, 0, 160, 'referral_count', JSON_OBJECT('threshold', 5), NOW(), NOW()),
('invite_10_friends', 'Comunidade em movimento', 'Convidou 10 pessoas que criaram conta no dotti.work.', 'special', 'platinum', '/uploads/media/badges/invite_10_friends.png', 'Insignia de comunidade em movimento', 'sparkles', 1, 0, 170, 'referral_count', JSON_OBJECT('threshold', 10), NOW(), NOW()),
('alpha_user', 'Alpha user', 'Entrou ate 30/10/2026 e completou os primeiros objetivos.', 'special', 'platinum', '/uploads/media/badges/alpha_user.png', 'Insignia de alpha user do dotti.work', 'star', 1, 0, 180, 'alpha_user', JSON_OBJECT('deadline', '2026-10-30', 'threshold', 5), NOW(), NOW());
