...
('complete_profile', 'Complete profile', 'Completed the initial onboarding.', 'onboarding', 'bronze', 'Complete profile badge', 'user-check', 1, 0, 10, 'profile_onboarding_completed', JSON_OBJECT('target', 1), NOW(), NOW()),
('stack_configured', 'Stack configured', 'Added at least 3 technologies to the profile.', 'onboarding', 'bronze', 'Stack configured badge', 'code', 1, 0, 20, 'technology_count', JSON_OBJECT('threshold', 3), NOW(), NOW()),
('preferences_defined', 'Preferences defined', 'Saved matching preferences.', 'onboarding', 'bronze', 'Preferences defined badge', 'sliders-horizontal', 1, 0, 30, 'preferences_defined', JSON_OBJECT('target', 1), NOW(), NOW()),
('explorer', 'Explorer', 'Viewed 5 open source projects.', 'discovery', 'silver', 'Open source explorer badge', 'compass', 1, 0, 40, 'activity_event_count', JSON_OBJECT('event_type', 'viewed_project', 'threshold', 5, 'distinct_repositories', true), NOW(), NOW()),
('curator', 'Curator', 'Saved 3 projects to follow.', 'discovery', 'silver', 'Project curator badge', 'bookmark', 1, 0, 50, 'repository_state_count', JSON_OBJECT('states', JSON_ARRAY('saved'), 'threshold', 3), NOW(), NOW()),
('technical_focus', 'Technical focus', 'Saved projects from at least 3 different languages.', 'discovery', 'silver', 'Technical focus badge', 'layers', 1, 0, 60, 'repository_language_saved_count', JSON_OBJECT('threshold', 3), NOW(), NOW()),
('first_action', 'First action', 'Opened a repository on GitHub for the first time.', 'contribution', 'bronze', 'First GitHub action badge', 'external-link', 1, 0, 70, 'activity_event_exists', JSON_OBJECT('event_type', 'opened_github', 'target', 1), NOW(), NOW()),
('started_contributing', 'Started contributing', 'Marked a project as in contribution.', 'contribution', 'silver', 'Started contributing badge', 'rocket', 1, 0, 80, 'activity_event_or_repository_state_exists', JSON_OBJECT('event_type', 'started_contributing', 'states', JSON_ARRAY('researching', 'working'), 'target', 1), NOW(), NOW()),
('first_pr', 'First PR', 'Marked the first pull request as sent.', 'contribution', 'gold', 'First pull request badge', 'git-pull-request', 1, 0, 90, 'activity_event_or_repository_state_exists', JSON_OBJECT('event_type', 'sent_pull_request', 'states', JSON_ARRAY('pull_request_sent'), 'target', 1), NOW(), NOW()),
('first_contribution', 'First contribution', 'Marked the first contribution as completed.', 'contribution', 'gold', 'First open source contribution badge', 'award', 1, 0, 100, 'activity_event_or_repository_state_exists', JSON_OBJECT('event_type', 'marked_contributed', 'states', JSON_ARRAY('contributed'), 'target', 1), NOW(), NOW()),
('beginner_friend', 'Beginner ally', 'Interacted with 3 projects with good first issues.', 'quality', 'silver', 'Beginner ally badge', 'heart-handshake', 1, 0, 110, 'issue_label_interaction_count', JSON_OBJECT('label', 'good first issue', 'threshold', 3), NOW(), NOW()),
('help_wanted_helper', 'Helpful contributor', 'Interacted with 3 projects with help wanted issues.', 'quality', 'silver', 'Helpful contributor badge', 'hand-heart', 1, 0, 120, 'issue_label_interaction_count', JSON_OBJECT('label', 'help wanted', 'threshold', 3), NOW(), NOW()),
('exploration_streak', 'Exploration streak', 'Interacted with projects on 3 different days.', 'consistency', 'silver', 'Exploration streak badge', 'calendar-days', 1, 0, 130, 'activity_distinct_days', JSON_OBJECT('threshold', 3), NOW(), NOW()),
('open_source_week', 'Open source week', 'Had activity on 5 days within 7 days.', 'consistency', 'gold', 'Open source week badge', 'calendar-check', 1, 0, 140, 'activity_distinct_days', JSON_OBJECT('threshold', 5, 'within_days', 7), NOW(), NOW()),
('invite_friend', 'Invite a friend', 'Invited one person who created a dotti.work account.', 'special', 'silver', 'Invite a friend badge', 'user-plus', 1, 0, 150, 'referral_count', JSON_OBJECT('threshold', 1), NOW(), NOW()),
('invite_5_friends', 'Open source connector', 'Invited 5 people who created dotti.work accounts.', 'special', 'gold', 'Open source connector badge', 'users', 1, 0, 160, 'referral_count', JSON_OBJECT('threshold', 5), NOW(), NOW()),
('invite_10_friends', 'Community in motion', 'Invited 10 people who created dotti.work accounts.', 'special', 'platinum', 'Community in motion badge', 'sparkles', 1, 0, 170, 'referral_count', JSON_OBJECT('threshold', 10), NOW(), NOW()),
('alpha_user', 'Alpha user', 'Joined by 2026-10-30 and completed the first goals.', 'special', 'platinum', 'dotti.work alpha user badge', 'star', 1, 0, 180, 'alpha_user', JSON_OBJECT('deadline', '2026-10-30', 'threshold', 5), NOW(), NOW()),
('first_key_first_egg', 'First to the key! First to the egg!', 'Awarded to the first 10 new members after this milestone opened.', 'special', 'legendary', 'First to the key and first to the egg badge', 'key-round', 1, 0, 190, 'signup_cohort_first_n', JSON_OBJECT('cohort', 'first_key_first_egg', 'limit', 10, 'target', 1), NOW(), NOW());
